...
public class zombieScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ((Vector3.Distance(zombie.transform.position, Camera.main.transform.position) <5))
            {
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        while (Vector3.Distance(zombie.transform.position, Camera.main.transform.position) <= 3000000000)
        {
